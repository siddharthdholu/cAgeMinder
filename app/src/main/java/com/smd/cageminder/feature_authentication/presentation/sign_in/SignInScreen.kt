...
import com.smd.cageminder.feature_authentication.presentation.sign_in.components.signInButton
import com.smd.cageminder.feature_authentication.presentation.sign_in.components.signInButtonWithIcon
...
import com.smd.cageminder.ui.theme.Blue03
import com.smd.cageminder.ui.theme.DarkGray01
        ...
        Column(
            ...
            Column(
                ...
                signInButtonWithIcon(
                    ...
                    textColor = DarkGray01
                )
                Spacer(modifier = Modifier.height(12.dp))
                signInButtonWithIcon(
                    text = stringResource(id = R.string.sign_in_with_facebook),
                    onClick = { viewModel.onEvent(SignInEvent.SignInWithFacebook) },
                    icon = painterResource(id = R.drawable.ic_fb_logo),
                ...
                Row(
                    ...
                    signInClickableText(text = stringResource(id = R.string.sign_up),
                        color = Blue01,
